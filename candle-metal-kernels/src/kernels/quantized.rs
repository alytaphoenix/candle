...
pub fn call_quantized_matmul_mv_id(
    ...
    let (nth0, nth1, divisor) = match dtype {
        GgmlDType::Q4_0 | GgmlDType::Q4_1 | GgmlDType::Q5_0 | GgmlDType::Q5_1 | GgmlDType::Q8_0 => (8usize, 8usize, 8usize),
        ...
        GgmlDType::BF16 => Err(MetalKernelError::UnsupportedDTypeForOp("BF16", "qmatmul_mv_id"))?,
        GgmlDType::Q8_1 => Err(MetalKernelError::UnsupportedDTypeForOp("Q8_1", "qmatmul_mv_id"))?,
        GgmlDType::Q8K => Err(MetalKernelError::UnsupportedDTypeForOp("Q8K", "qmatmul_mv_id"))?,
    };
